...
Устанавливаю Node.js иригид pnpm, которые необходимы для работы с инструментами семантического версионирования и общепринятых коммитов (рис. [-@fig:002]).
...
Выполняю настройку pnpm для добавления каталога с исполняемыми файлами в переменную PATH. Команда `pnpm setup` уже была выполнена ранее (рис. [-@fig:003]).
