...
Домашний каталог: /home/dbignatenko.
...
![Содержимое /tmp (команда ls)](image/3.png){#fig:003 width=70%}

Команда ls выводит только имена файлов и каталогов.

Вывожу содержимое каталога /tmp с опцией -a для отображения скрытых файлов (рис. -@fig:004).

```bash
ls -a
```

![Содержимое /tmp (команда ls -a)](image/4.png){#fig:004 width=70%}

Опция -a показывает все файлы, включая скрытые (начинающиеся с точки).

Вывожу содержимое каталога /tmp с опцией -l для подробного списка (рис. -@fig:005).

```bash
ls -l
```

![Содержимое /tmp (команда ls -l)](image/5.png){#fig:005 width=70%}

Опция -l выводит подробную информацию: права доступа, число ссылок, владелец, группа, размер, дата изменения и имя.
...
![Содержимое /tmp (команда ls -alF)](image/6.png){#fig:006 width=70%}
...
Владельцем всех файлов и подкаталогов является пользователь dbignatenko.
...
![Создание каталогов newdir и morefun](image/9.png){#fig:009 width=70%}
...
![Попытка удаления каталога rm](image/11.png){#fig:011 width=70%}
...
![Удаление каталогов morefun и newdir](image/12.png){#fig:012 width=70%}
...
![man ls — опция -R](image/13.png){#fig:013 width=70%}
...
![Рекурсивный просмотр ls -R](image/14.png){#fig:014 width=70%}
...
![man ls — опция -l](image/15.png){#fig:015 width=70%}

![man ls — опция -t](image/16.png){#fig:016 width=70%}
...
![Сортировка по времени ls -lt](image/17.png){#fig:017 width=70%}
...
![man pwd](image/19.png){#fig:019 width=70%}
...
![man mkdir](image/20.png){#fig:020 width=70%}
...
![man rmdir](image/21.png){#fig:021 width=70%}
...
![man rm](image/22.png){#fig:022 width=70%}
...
![Вывод истории команд](image/23.png){#fig:023 width=70%}
...
![Модификация команды из истории](image/24.png){#fig:024 width=70%}

Команда `ls -a` (номер 773) была изменена на `ls -F` и выполнена.
...
```bash
!773:s/a/F  # Заменить 'a' на 'F' в команде №773
```
...
Абсолютный путь: `/home/dbignatenko/work/file.txt`
