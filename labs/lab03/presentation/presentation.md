...
Описываю выполнение работы с текстом, блоками кода и ссылками на скриншоты.
...
Выполняю компиляцию командой make. Pandoc создаёт report.pdf и report.docx.

![Запуск make](image/6.png){#fig:006 width=70%}

## Проверка результатов

Проверяю содержимое каталога командой ls — файлы успешно созданы.
