...
Проверяю версии установленного ПО: git, go, node.
...
Создаю репозиторий den4ik-dev.github.io на основе шаблона HugoBlox.
...
- Сайт успешно опубликован по адресу https://den4ik-dev.github.io/
