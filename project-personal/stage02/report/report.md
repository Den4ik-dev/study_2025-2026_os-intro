...
- **Имя**: Игнатенко Денис Беньяминович
...
В посте описываю своё выступление на концерте в РУДН в честь 8 марта, где вместе с группой по английскому языку мы исполнили песню "In My Lonely Life" Сергея Лазарева.
...
В ходе выполнения второго этапа индивидуального проекта добавил к персональному сайту данные о себе: разместил фотографию, заполнил биографию, указал интересы и информацию об образовании. Также создал два поста: о прошедшей неделе и на тему "Управление версиями. Git". Сайт успешно обновлён и доступен по адресу `https://den4ik-dev.github.io/`.
